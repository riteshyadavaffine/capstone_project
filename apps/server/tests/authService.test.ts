...
describe('authService', () => {
  ...
  it('rejects invalid credentials', async () => {
    await expect(login('customer@supportpilot.dev', 'wrong-password')).rejects.toThrow(
      'We could not find an account with those details. Please check your email and password.',
    );
  });
});
